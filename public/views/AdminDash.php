...
<body class="bg-gray-100">
    ...
    <aside class="w-64 h-screen bg-gray-800 text-white p-6 fixed">
        ...
        <nav class="space-y-6">
            <a href="#gestion-articles" class="flex items-center space-x-3 text-lg hover:text-purple-400 active:text-purple-600" id="link-gestion-articles" onclick="setActiveSection('link-gestion-articles')" aria-label="Gestion des Articles">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2h-5V4H2v16h15z"></path>
                </svg>
                <span>Gestion des Articles</span>
            </a>
            <a href="#gestion-categories" class="flex items-center space-x-3 text-lg hover:text-purple-400 active:text-purple-600" id="link-gestion-categories" onclick="setActiveSection('link-gestion-categories')" aria-label="Gestion des Catégories">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4h10M7 10h10M7 16h10"></path>
                </svg>
                <span>Gestion des Catégories</span>
            </a>
            <a href="#gestion-utilisateurs" class="flex items-center space-x-3 text-lg hover:text-purple-400 active:text-purple-600" id="link-gestion-utilisateurs" onclick="setActiveSection('link-gestion-utilisateurs')" aria-label="Gestion des Utilisateurs">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6H2v16h16V6h-2m-2 0v16h-8V6H4z"></path>
                </svg>
                <span>Gestion des Utilisateurs</span>
            </a>
            <a href="#gestion-tags" class="flex items-center space-x-3 text-lg hover:text-purple-400 active:text-purple-600" id="link-gestion-tags" onclick="setActiveSection('link-gestion-tags')" aria-label="Gestion des Tags">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6H2v16h16V6h-2m-2 0v16h-8V6H4z"></path>
                </svg>
                <span>Gestion des Tags</span>
            </a>
            <a href="#gestion-commentaires" class="flex items-center space-x-3 text-lg hover:text-purple-400 active:text-purple-600" id="link-gestion-commentaires" onclick="setActiveSection('link-gestion-commentaires')" aria-label="Gestion des Commentaires">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 11.5a8.38 8.38 0 01-3.16.61A8.48 8.48 0 013 12.5a8.38 8.38 0 01-3.16-.61m18 0a8.38 8.38 0 003.16-.61M12 12l-1.45 4.38a1.75 1.75 0 01-3.3 0L6 12m5.5 0a6.5 6.5 0 01-11 0m11 0a6.5 6.5 0 0011 0m-11 0V5"></path>
                </svg>
